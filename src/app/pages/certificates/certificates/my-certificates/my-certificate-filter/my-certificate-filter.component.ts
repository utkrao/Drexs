...
@Component({
  selector: 'app-my-certificate-filter',
  templateUrl: './my-certificate-filter.component.html',
  styleUrls: ['./my-certificate-filter.component.scss']
})
export class MyCertificateFilterComponent implements OnInit {
  ...
  getRangeValue(){
    return this.filterForm.value.daysRange || 0;
  }
