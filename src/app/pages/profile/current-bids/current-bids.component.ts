...
@Component({
  selector: 'app-current-bids',
  templateUrl: './current-bids.component.html',
  styleUrls: ['./current-bids.component.scss']
})
export class CurrentBidsComponent implements OnInit {
  loading: boolean;
  count: number;
  limit: number;
  page: number;
